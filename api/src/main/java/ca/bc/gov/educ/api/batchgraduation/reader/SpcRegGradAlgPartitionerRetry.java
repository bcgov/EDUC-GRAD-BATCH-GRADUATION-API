...
public class SpcRegGradAlgPartitionerRetry extends BasePartitioner {

    private static final Logger LOGGER = LoggerFactory.getLogger(SpcRegGradAlgPartitionerRetry.class);

    @Value("#{stepExecution.jobExecution}")
    JobExecution jobExecution;

    public SpcRegGradAlgPartitionerRetry() {
        super();
