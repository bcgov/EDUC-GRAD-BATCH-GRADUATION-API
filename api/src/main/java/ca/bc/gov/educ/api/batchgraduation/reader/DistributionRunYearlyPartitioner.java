...
public class DistributionRunYearlyPartitioner extends SimplePartitioner {
    ...
    public Map<String, ExecutionContext> partition(int gridSize) {
        ...
        List<String> schoolsList = parallelDataFetch.fetchDistributionRequiredDataDistrictsYearly(restUtils.getAccessToken());
