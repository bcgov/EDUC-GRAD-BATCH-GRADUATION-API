...
public class NatsConnection implements Closeable {
   ...
   *
   * @param batchGraduationApiConstants the application properties
   * @throws IOException          the io exception
   * @throws InterruptedException the interrupted exception
   */
  @Autowired
  public NatsConnection(final EducGradBatchGraduationApiConstants batchGraduationApiConstants) throws IOException, InterruptedException {
    this.natsCon = this.connectToNats(batchGraduationApiConstants.getNatsServer(), batchGraduationApiConstants.getMaxReconnect(), batchGraduationApiConstants.getConnectionName());
  }
