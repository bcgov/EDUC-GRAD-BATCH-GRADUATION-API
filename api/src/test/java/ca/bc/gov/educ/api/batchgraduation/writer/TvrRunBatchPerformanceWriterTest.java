...
@ActiveProfiles("test")
@Ignore
public class TvrRunBatchPerformanceWriterTest {

    private static final String TIME = "time";
    private static final String JOB_TRIGGER="jobTrigger";
    private static final String JOB_TYPE="jobType";

    private TvrRunBatchPerformanceWriter tvrRunBatchPerformanceWriter;
    ...
    public void testWrite() throws Exception {
        TvrRunBatchPerformanceWriter tvrRunBatchPerformanceWriter = new TvrRunBatchPerformanceWriter();
        ...
        tvrRunBatchPerformanceWriter.write(list);
