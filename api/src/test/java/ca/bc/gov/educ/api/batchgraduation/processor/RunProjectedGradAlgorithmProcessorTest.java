...
public class RunProjectedGradAlgorithmProcessorTest {
    ...
    public void testRetrieveSummaryDto() throws JobInstanceAlreadyCompleteException, JobExecutionAlreadyRunningException, JobParametersInvalidException, JobRestartException {
        ...
        runProjectedGradAlgorithmProcessor.retrieveSummaryDto(stepExecution);
    ...
    public void testProcess() throws Exception {
        ...
        Mockito.when(gradAlgorithmService.processProjectedGradStudent(grd, summaryDTO)).thenReturn(grd);
