...
@SpringBootTest
@ActiveProfiles("test")
public class RecalculateProjectedGradRunReaderTest {
    ...
    @Autowired
    private RecalculateProjectedGradRunReader recalculateProjectedGradRunReader;
    @MockBean
    ...
    public void testInitializeSummaryDto() throws JobInstanceAlreadyCompleteException, JobExecutionAlreadyRunningException, JobParametersInvalidException, JobRestartException {
        ...
        recalculateProjectedGradRunReader.initializeSummaryDto(stepExecution);
    ...
    public void testRead() throws Exception {
        ...
        Mockito.when(restUtils.getStudentsForProjectedAlgorithm(summaryDTO.getAccessToken())).thenReturn(list);

        recalculateProjectedGradRunReader.read();
