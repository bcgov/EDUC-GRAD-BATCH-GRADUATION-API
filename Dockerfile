...
ENTRYPOINT ["java","-Duser.name=EDUC_GRAD_BATCH_GRADUATION_API","-Xms2500m","-Xmx2500m","-noverify","-XX:TieredStopAtLevel=1",\
            ...
            "ca.bc.gov.educ.api.batchgraduation.EducGradBatchGraduationApplication"]
